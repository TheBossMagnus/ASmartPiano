...
const uint8_t BUTTON_PIN_DO = 6;
const uint8_t BUTTON_PIN_RE = 7;
const uint8_t BUTTON_PIN_MI = 8;
const uint8_t BUTTON_PIN_FA = 9;
const uint8_t BUTTON_PIN_SOL = 10;
const uint8_t BUTTON_PIN_LA = 11;
const uint8_t BUTTON_PIN_SI = 12;
const uint8_t BUTTON_PIN_DOA = 13;
...
void setup() {
    ...
    pinMode(BUTTON_PIN_DOA, INPUT_PULLUP);
